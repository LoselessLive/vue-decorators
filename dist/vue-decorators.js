...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(117), __webpack_require__(88)))
...
exports.Mutation = exports.Getter = exports.Action = exports.State = exports.Lifecycle = exports.Watch = exports.Prop = exports.Component = undefined;

var _component = __webpack_require__(120);

var _component2 = _interopRequireDefault(_component);

var _prop = __webpack_require__(122);

var _prop2 = _interopRequireDefault(_prop);

var _watch = __webpack_require__(123);

var _watch2 = _interopRequireDefault(_watch);

var _lifecycle = __webpack_require__(121);
...
var _getter = __webpack_require__(125);

var _getter2 = _interopRequireDefault(_getter);

var _mutation = __webpack_require__(126);
...
exports.Getter = _getter2.default;
...
var _special = __webpack_require__(28);
...
function combineDataObject(vm, Component) {
  ...
  [].concat(_toConsumableArray(Object.getOwnPropertyNames(vm)), _toConsumableArray(Object.getOwnPropertyNames(new _vue2.default()))).forEach(function (key) {
    data.delete(key);
  });
...
function componentFactory(Component) {
  ...
  var Super = proto instanceof _vue2.default ? proto.constructor : _vue2.default;

  /** Methods **/
  if (!proto[_special2.default.METHODS]) {
    proto[_special2.default.METHODS] = {};
  }

  var componentMethods = new Set(Object.getOwnPropertyNames(proto));
  componentMethods.delete('constructor');

  for (var key in _special2.default) {
    componentMethods.delete(_special2.default[key]);
  }

  if (proto[_special2.default.USED_PROPS]) {
    for (var _key in proto[_special2.default.USED_PROPS]) {
  ...
  try {
    for (var _iterator2 = componentMethods.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      proto[_special2.default.METHODS][method] = proto[method];
    }
  ...
  options = _extends({}, options, proto[_special2.default.LIFECYCLE]);
  options.name = options.name || Component.name;
  options.data = options.data;
  options.props = _extends({}, options.props, proto[_special2.default.PROPS]);
  options.watch = _extends({}, options.watch, proto[_special2.default.WATCHERS]);
  options.computed = _extends({}, options.computed, proto[_special2.default.STATES], proto[_special2.default.GETTERS]);
  options.methods = _extends({}, options.methods, proto[_special2.default.METHODS], proto[_special2.default.ACTIONS], proto[_special2.default.MUTATIONS]);
...
function makeLifecycleDecorator(options) {
  return function (target, key) {
    if (!target[_special2.default.USED_PROPS]) {
      target[_special2.default.USED_PROPS] = {};
    }

    if (!target[_special2.default.LIFECYCLE]) {
      target[_special2.default.LIFECYCLE] = {};
    }

    if (!target[_special2.default.LIFECYCLE][options || key]) {
      target[_special2.default.USED_PROPS][key] = true;
      target[_special2.default.LIFECYCLE][options || key] = target[key];
    }
  };
}

function Lifecycle(options, key, descriptor) {
  if (options instanceof _vue2.default) {
...
function makePropDecorator(options) {
  return function (target, key) {
    ...
    if (!target[_special2.default.PROPS]) {
      target[_special2.default.PROPS] = {};
    }

    if (!target[_special2.default.PROPS][key]) {
      target[_special2.default.USED_PROPS][key] = true;
      target[_special2.default.PROPS][key] = options || true;
    }
  };
}
...
function makeWatchDecorator(options) {
  return function (target, key) {
    ...
    if (!target[_special2.default.WATCHERS]) {
      target[_special2.default.WATCHERS] = {};
    }

    if (!target[_special2.default.WATCHERS][options || key]) {
      target[_special2.default.USED_PROPS][key] = true;
      target[_special2.default.WATCHERS][options || key] = target[key];
    }
  };
}
...
exports.default = function (options, key, descriptor) {
  if (options instanceof _vue2.default) {
...
function makeActionDecorator(options) {
  return function (target, key) {
    ...
    if (!target[_special2.default.ACTIONS]) {
      target[_special2.default.ACTIONS] = {};
    }

    if (!target[_special2.default.ACTIONS][key]) {
      target[_special2.default.USED_PROPS][key] = true;
      target[_special2.default.ACTIONS][key] = (0, _vuex.mapActions)([options || key])[options || key];
    }
  };
}
...
function makeGetterDecorator(options) {
  return function (target, key) {
    ...
    if (!target[_special2.default.GETTERS]) {
      target[_special2.default.GETTERS] = {};
    }

    if (!target[_special2.default.GETTERS][key]) {
      target[_special2.default.USED_PROPS][key] = true;
      target[_special2.default.GETTERS][key] = (0, _vuex.mapGetters)([options || key])[options || key];
    }
  };
}
...
function makeMutationDecorator(options) {
  return function (target, key) {
    ...
    if (!target[_special2.default.MUTATIONS]) {
      target[_special2.default.MUTATIONS] = {};
    }

    if (!target[_special2.default.MUTATIONS][key]) {
      target[_special2.default.USED_PROPS][key] = true;
      target[_special2.default.MUTATIONS][key] = (0, _vuex.mapMutations)([options || key])[options || key];
    }
  };
}
...
function makeStateDecorator(options) {
  return function (target, key) {
    ...
    if (!target[_special2.default.STATES]) {
      target[_special2.default.STATES] = {};
    }

    if (!target[_special2.default.STATES][key]) {
      target[_special2.default.USED_PROPS][key] = true;
      target[_special2.default.STATES][key] = (0, _vuex.mapState)([options || key])[options || key];
    }
  };
}
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(88), __webpack_require__(117)))
